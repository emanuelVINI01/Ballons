...
class BowReduceEffect(plugin: Balloons, private val percent : Double, private val chance : Double?, private val message : String?, private val messageTarget : String?) : Effect(
    EffectType.BOW_REDUCTION, plugin) {
                    ...
                    if (arrow.shooter is Player) {
                        ...
                        if (shooter.name == player.name) {
                            if (
                                ...
                                event.damage = event.damage * percent
                            }
                        }
                    }
                }
